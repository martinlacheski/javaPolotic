...
@WebServlet(name = "SvHuespedDelete", urlPatterns = {"/SvHuespedDelete"})
public class SvHuespedDelete extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        controlHuesped.eliminarHuesped(id, dni, nombres, apellido, fechaNacimiento, direccion, profesion);
