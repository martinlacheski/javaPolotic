...
@WebServlet(name = "SvUsuarioDelete", urlPatterns = {"/SvUsuarioDelete"})
public class SvUsuarioDelete extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //Traigo los datos del usuarioForm.jsp
        String username = request.getParameter("username");
        String password = request.getParameter("password");
        
        //Convertimos a tipo Boolean el value del CHECKBOX
        boolean isJefe = Boolean.parseBoolean(request.getParameter("isJefeHidden"));    
        
        //LLamamos a la controladora de la Logica
        UsuarioControladora  control = new UsuarioControladora();
        control.eliminarUsuario(id, username, password, isJefe);
