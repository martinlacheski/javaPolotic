...
@WebServlet(name = "SvUsuarioEdit", urlPatterns = {"/SvUsuarioEdit"})
public class SvUsuarioEdit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        control.actualizarUsuario(id, username, password, isJefe);
