...
@WebServlet(name = "SvReservaEdit", urlPatterns = {"/SvReservaEdit"})
public class SvReservaEdit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        controlReserva.actualizarReserva(id, huesped, checkIN, checkOUT, cantPersonas, habitacionGuardar, importeGuardar, usuario);
