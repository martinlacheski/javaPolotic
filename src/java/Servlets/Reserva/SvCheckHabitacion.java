...
@WebServlet(name = "SvCheckHabitacion", urlPatterns = {"/SvCheckHabitacion"})
public class SvCheckHabitacion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //Traigo los datos del reservaCreate.jsp
        ...
        isValid = control.checkReservasHabitacion(habitacion, checkIn, checkOut);
