...
<%@page import="Logica.EmpleadoControladora"%>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control select2" id="usuario" name="usuario">
                                                    ...
                                                    <c:if test="${usuario.getApellido().isBlank() == false}">
                                                        <option value="${usuario.getId()}">${usuario.getApellido()}, ${usuario.getNombre()}</option>
                                                    </c:if >
                                                    <% EmpleadoControladora control = new EmpleadoControladora();
                                                        List<Empleado> empleados = control.listarUsuariosEmpleados();
                                                        for (Empleado empl : empleados) {
                                                    %>
                                                    <%int id = empl.getId();%>
                                                    <option value="<%=id%>"><%String empleado = empl.getApellido() + ", " + empl.getNombre();%><%=empleado%></option>
                                                    <% }%>
                                                </select>
                                                <div class="input-group-append">
                                                    <button type="submit" name="accion" value="reporteUsuario" class="btn btn-success btn-flat btnAddHuesped">
