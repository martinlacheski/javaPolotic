                                ...
                                <div class="col-md-12">
                                    <div class="card bg-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="SvTipoDelete" method="POST">
                                                <input type="hidden" name="id" value="${idTipo}">
                                                <div class="form-group">
                                                    <label for="tipo">
                                                        Tipo de Habitación
                                                    </label>
                                                    <input type="text" class="form-control" readonly id="tipo" name="tipo"
                                                           value="${tipo}" minlength="4" autocomplete="off" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="capacidad">
                                                        Capacidad
                                                    </label>
                                                    <input type="text" class="form-control" readonly id="capacidad" name="capacidad" onkeypress="return isNumberKey(event)"
                                                           value="${capacidad}" minlength="1" autocomplete="off" required>
                                                </div>
                                                
                                                <button type="submit" class="btn btn-primary" value="Update">
                                                    <i class="far fa-trash-alt"></i> Eliminar Tipo
                                                </button>
