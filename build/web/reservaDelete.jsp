<%@page import="Logica.ReservaControladora"%>
<%@page import="Logica.HabitacionControladora"%>
            ...
            $(function () {
                ...
                $("#checkout").on('change', function (e) {
                    ...
                    if (dateIN > dateOUT) {
                        $.alert({
                            title: 'Error!',
                            content: 'La fecha de CHECK-OUT debe ser mayor que la de CHECK-IN',
                        });
                                ...
                                <div class="col-md-12">
                                    <div class="card bg-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="SvReservaDelete" method="POST">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control select" id="huesped" name="huesped" disabled required>
                                                            <!-- Utilizamos JSTL para cargar el combobox-->
                                                            <option value="${huesped.getId()}">${huesped.getApellido()}, ${huesped.getNombre()}</option>
                                                            <input type="hidden" name="huesped" value="${huesped.getId()}">
                                                        </select>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="date" class="form-control" checkin id="checkin" name="checkin"
                                                                       value="${checkin}" readonly required>
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <label for="checkout">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="date" class="form-control" checkout id="checkout" name="checkout"
                                                                       value="${checkout}" readonly required>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            ...
                                                            <select class="form-control" id="habitacion" disabled name="habitacion">
                                                                <!-- Utilizamos JSTL para cargar el combobox-->
                                                                <option value="${hab.getId()}">${habitacion.getNombre()}</option>
                                                                <input type="hidden" name="habitacion" value="${habitacion.getId()}">
                                                            </select>
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <input type="number" min="1" class="form-control" id="cantidad" name="cantidad" 
                                                                   ...
                                                                   value="${cantPersonas}" readonly required>
                                                        </div>
                                                        <div class="col-4">
                                                            <label for="importe">
                                                                Importe
                                                    ...
                                                    <button type="button" method="POST" id="btnCheck" name="accion" value="chequear" disabled class="btn btn-success">
                                                        <i class="far fa-calendar-check"></i> Chequear habitacion
                                                    </button>
                                                    <button type="submit" name="accion" value="guardar" id="btnGuardar"  btnGuardar 
                                                            class="btn btn-primary" value="Generar reserva">
