                    ...
                    <div class="container">
                        ...
                        <div class="card card-default">
                                ...
                                <table class="table" id="data" name="tabla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 45%;">Tipo</th>
                                            <th scope="col" style="width: 25%;">Capacidad</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${tipos}" var="tipo">
                                            <tr>
                                                <td>${tipo.getId()}</td>
                                                <td>${tipo.getTipo()}</td>
                                                <td>${tipo.getCapacidad()}</td>
                                                <td>
                                                    <!-- Redireccionamos al Servlet correspondiente-->
                                                    <form action="SvTipoList" method="POST">
                            ...
                            <div class="card-footer">
                                <a href="tipoCreate.jsp" class="btn btn-primary btn-flat btnTest">
                                    <i class="fas fa-plus"></i> Nuevo Tipo
                                </a>
                                <a href="SvTipoList" class="btn btn-success btn-flat">
