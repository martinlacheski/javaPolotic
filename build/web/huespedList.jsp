                    ...
                    <div class="container">
                        ...
                        <div class="card card-default">
                                ...
                                <table class="table" id="data" name="tabla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 20%;">Profesión</th>
                                            <th scope="col" style="width: 20%;">Opciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <!-- Utilizamos JSTL para recorrer la lista -->
                                        <c:forEach items="${huespedes}" var="huesped">
                                            <tr>
                                                <td>${huesped.getId()}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="SvHuespedList" method="POST">
                            ...
                            <div class="card-footer">
                                <a href="SvHuespedCreate" class="btn btn-primary btn-flat btnTest">
                                    <i class="fas fa-plus"></i> Nuevo Huesped
                                </a>
                                <a href="SvHuespedList" class="btn btn-success btn-flat">
