                    ...
                    <div class="container">
                        ...
                        <div class="card card-default">
                                ...
                                <table class="table" id="data" name="tabla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 45%;">Usuario</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${users}" var="user">
                                            <tr>
                                                ...
                                                <td>${user.getIsJefe()}</td>
                                                <td>
                                                    <!-- Redireccionamos al Servlet correspondiente-->
                                                    <form action="SvUsuarioList" method="POST">
                            ...
                            <div class="card-footer">
                                <a href="usuarioCreate.jsp" class="btn btn-primary btn-flat btnTest">
                                    <i class="fas fa-plus"></i> Nuevo Usuario
                                </a>
                                <a href="SvUsuarioList" class="btn btn-success btn-flat">
