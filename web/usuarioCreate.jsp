                                ...
                                <div class="col-md-12">
                                    <div class="card bg-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="SvUsuarioCreate" method="POST">
                                                <div class="form-group">
                                                    <label for="username">
                                                        Nombre de Usuario
                                                    </label>
                                                    <input type="text" class="form-control" id="username" name="username"
                                                           placeholder="Ingrese el nombre de usuario" minlength="4" autocomplete="off" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="password">
                                                        Contraseña
                                                    ...
                                                    <input type="password" class="form-control" id="password" name="password"
                                                           placeholder="Ingrese la contraseña" minlength="4" autocomplete="off" required>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
