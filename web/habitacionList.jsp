                    ...
                    <div class="container">
                        ...
                        <div class="card card-default">
                                ...
                                <table class="table" id="data" name="tabla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 15%;">Piso</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${habitaciones}" var="hab">
                                            <tr>
                                                ...
                                                <td>${hab.getNombre()}</td>
                                                <td>${hab.getTipo()}</td>
                                                <td>${hab.getCapacidad()}</td>
                                                <td>${hab.getPiso()}</td>
                                                <td>${hab.getPrecio()}</td>
                                                <td>
                                                    <!-- Redireccionamos al Servlet correspondiente-->
                                                    <form action="SvHabitacionList" method="POST">
                            ...
                            <div class="card-footer">
                                <a href="SvHabitacionCreate" class="btn btn-primary btn-flat btnTest">
                                    <i class="fas fa-plus"></i> Nueva Habitación
                                </a>
                                <a href="SvHabitacionList" class="btn btn-success btn-flat">
