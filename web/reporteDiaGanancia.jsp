                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">
                                    ...
                                    Reporte de Recaudación por día
                                </h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button type="submit" name="accion" value="reporteDiaGanancia" class="btn btn-success btn-flat btnAddHuesped">
                                        ...
                                        <div class="col-2 pull-right">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control pull-right" readonly checkDia id="ganancia" name="ganancia"
                                                       value="${ganancia}">
                                            </div>
                                        </div>        
                                    </div>
