                                ...
                                <div class="col-md-12">
                                    <div class="card bg-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="SvHabitacionEdit" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nombre" name="nombre"
                                                           value="${nombre}" minlength="2" autocomplete="off" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="tipo">
                                                        Tipo                                               
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" class="form-control" id="piso" name="piso" onkeypress="return isNumberKey(event)"
                                                           value="${piso}" minlength="1" autocomplete="off" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="precio">
                                                        Precio por noche
                                                    ...
                                                    <input type="text" class="form-control" id="precio" name="precio" onkeypress="return isDoubleKey(event)"
                                                           value="${precio}" minlength="1" autocomplete="off" required>
                                                </div>
