                    ...
                    <div class="container">
                        ...
                        <div class="card card-default">
                                        ...
                                        <c:forEach items="${empleados}" var="empleado">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="SvEmpleadoList" method="POST">
                            ...
                            <div class="card-footer">
                                <a href="SvEmpleadoCreate" class="btn btn-primary btn-flat btnTest">
                                    <i class="fas fa-plus"></i> Nuevo Empleado
                                </a>
                                <a href="SvEmpleadoList" class="btn btn-success btn-flat">
