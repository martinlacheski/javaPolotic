                                ...
                                <div class="col-md-12">
                                    <div class="card bg-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="SvHuespedDelete" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" readonly id="profesion" name="profesion"
                                                           value="${profesion}" minlength="4" autocomplete="off" required>
                                                </div>
                                                <button type="submit" class="btn btn-primary" value="Update">
                                                    <i class="far fa-trash-alt"></i> Eliminar Huesped
                                                </button>
