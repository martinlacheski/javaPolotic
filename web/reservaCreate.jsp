                                ...
                                <div class="col-md-12">
                                    <div class="card bg-default">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="SvReservaCreate" method="POST">
                                                <div class="card-body">
                                                    <label for="huesped">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="date" class="form-control" checkout id="checkout" name="checkout"
                                                                       placeholder="Ingrese la fecha de checkout" required>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <input type="number" min="1" class="form-control" id="cantidad" name="cantidad" 
                                                                   value="1" onkeypress="return isNumberKey(event)" autocomplete="off" required>
                                                        </div>
                                                        <div class="col-4">
                                                            <label for="importe">
                                                                Importe
